...
namespace ImpGraphics
{
	...
	public:
		...
		/// 충돌 또는 픽킹을 위한 BoundingVolume 오브젝트 추가
		virtual IMPGRAPHICS void AddCubeBoundingVolume(size_t boundingVolumeID, Vector3 center, Vector3 length) abstract;
		virtual IMPGRAPHICS void AddSphereBoundingVolume(size_t boundingVolumeID, Vector3 center, float radius) abstract;
