...
namespace ImpGraphics
{
	...
	class AnimationObject : public IObject
	{
	public:
		AnimationObject(std::shared_ptr<GeometryBuffer> geometryBuffers, std::shared_ptr<Shader> shader, std::shared_ptr<Texture> texture = nullptr);
